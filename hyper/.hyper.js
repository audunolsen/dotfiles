// -- hyper-stylesheet-hash:047697fdffb4c6c4817af2ff64637248 --
...
module.exports = {
    config: {
        ...
        // set to `true` (without backticks and without quotes)
        // for blinking cursor
        cursorBlink: false,
        ...
        // additionally, set to `'left'` if you
        // want them on the left, like in Ubuntu
        // default: `true` (without backticks and without quotes)
        // on Windows and Linux, ignored on macOS
        showWindowControls: '',
        ...
        // if `true` (without backticks and without quotes),
        ...
        // (`true` by default on Windows and disables the context menu feature)
        quickEdit: false,

        // choose either `'vertical'`, if you want the column
        // mode when Option key is hold during selection (Default)
        // or `'force'`, if you want to force selection regardless
        ...
        // Set it to false to use canvas-based
